  ...
  try {
    ...
    if (accion === "redactar") {
      ...
      const instrucciones = [
        ...
        "  expliques la causa ni determines nada acá.",
        '- "causa_conclusion": SOLO la causa determinada y su explicación técnica',
        "  (por qué ocurría la falla, a qué corresponde la condición pendiente).",
        "  NO repitas los resultados de las pruebas. Si no hay causa clara,",
        "  escribe exactamente: No se establece una causa definitiva con los",
        "  antecedentes disponibles.",
        "  IMPORTANTE: resultado_pruebas y causa_conclusion NO deben repetir la",
        "  misma información — cada una aporta algo distinto (una, los hechos; la",
        "  otra, la explicación técnica).",
        '- "observaciones": recomendación/observación final o trabajo pendiente,',
        '  SOLO técnica (nada de garantía, cobros ni promesas). "" si no hay.',
